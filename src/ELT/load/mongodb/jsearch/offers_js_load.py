"""
Load : Offres JSearch brutes vers MongoDB
"""
import sys
...
from src.utils import load_latest_json, DATA_RAW_JSEARCH
...
def load_offres_raw_to_mongodb(db_name: str = "job_market"):
    ...
    offres, filepath = load_latest_json(DATA_RAW_JSEARCH, "offres*.json")
    ...
    # Insertion
    collection_name = 'offres_jsearch_raw'
